...
public class Design {
    ...
    public static void button_ui_style_black(JButton btn){
        btn.setBackground(new java.awt.Color(48, 48, 48));
        btn.setBorderPainted(true);
        btn.setBorder(null);
        btn.setFocusPainted(false);
        btn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 204)));
